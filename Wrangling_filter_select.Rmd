...
Per the data, 1,248 movies were released in 1995.
...
Per data, 10 comedies with an MPAA rating over 120 mins rated above 8.
...
The movie that had the highest votes per imb.com is Harry Potter and the Sorcerer's Stone.
...
# Check if the movie "Annie" is in the dataset
